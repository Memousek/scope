...
import { ScopesDashboard } from "./components/scope/ScopesDashboard";
...
export default function Home() {
  ...
  useEffect(() => {
    try {
      ...
      if (initialQ) setInitialQuery(initialQ);
    } catch {}
  ...
  if (user) {
    return <ScopesDashboard user={user} initialQuery={initialQuery} searchId="home-search" />;
  }
