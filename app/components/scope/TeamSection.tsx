          ...
          <div className="relative z-10">
            ...
            {team.length > 0 && (
              <div className="mt-8 mb-8 grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="hover:scale-[1.02] hover:shadow-2xl hover:shadow-blue-500/10 animate-in fade-in duration-300 bg-gradient-to-br from-white/90 to-white/70 dark:from-gray-700/90 dark:to-gray-700/70 backdrop-blur-sm rounded-xl p-4 border border-gray-200/50 dark:border-gray-600/50 shadow-lg">
