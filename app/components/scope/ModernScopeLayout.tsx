            ...
            <div className="relative bg-gradient-to-br from-white/80 via-white/60 to-white/40 dark:from-gray-800/80 dark:via-gray-800/60 dark:to-gray-800/40 backdrop-blur-xl border border-white/30 dark:border-gray-600/30 rounded-2xl p-8 shadow-2xl">
              ...
              <div className="relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="relative">
                          <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-purple-500 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg">
                            <span className="text-white text-2xl">👥</span>
                                                 ...
                                                 <div>
                           <p className="text-sm text-gray-600 dark:text-gray-400 font-medium">Členové týmu</p>
                  ...
                  {/* Aktivní projekty */}
                  <div className="relative group bg-gradient-to-br from-white/90 via-white/70 to-white/50 dark:from-gray-700/90 dark:via-gray-700/70 dark:to-gray-700/50 backdrop-blur-lg rounded-2xl border border-white/40 dark:border-gray-600/40 overflow-hidden transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-green-500/10 animate-in slide-in-from-bottom-4 duration-500" style={{ animationDelay: '100ms' }}>
                    <div className="absolute inset-0 bg-gradient-to-r from-green-500/0 via-emerald-500/0 to-teal-500/0 group-hover:from-green-500/5 group-hover:via-emerald-500/5 group-hover:to-teal-500/5 transition-all duration-500 rounded-2xl"></div>
                    <div className="p-6 relative">
                      <div className="flex items-center gap-4">
                        <div className="relative">
                          <div className="w-16 h-16 bg-gradient-to-br from-emerald-600 to-green-700 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg">
                            <span className="text-white text-2xl">🚀</span>
                                                 ...
                                                 <div>
                           <p className="text-sm text-gray-600 dark:text-gray-400 font-medium">Aktivní projekty</p>
                           <div className="text-3xl font-bold text-gray-900 dark:text-white">
                             {loadingStats ? (
                               <div className="animate-pulse bg-gray-300 dark:bg-gray-600 h-8 w-16 rounded"></div>
                             ) : (
                  ...
                  {/* Průměrný skluz */}
                  <div className="relative group bg-gradient-to-br from-white/90 via-white/70 to-white/50 dark:from-gray-700/90 dark:via-gray-700/70 dark:to-gray-700/50 backdrop-blur-lg rounded-2xl border border-white/40 dark:border-gray-600/40 overflow-hidden transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-orange-500/10 animate-in slide-in-from-bottom-4 duration-500" style={{ animationDelay: '200ms' }}>
                    <div className="absolute inset-0 bg-gradient-to-r from-orange-500/0 via-red-500/0 to-pink-500/0 group-hover:from-orange-500/5 group-hover:via-red-500/5 group-hover:to-pink-500/5 transition-all duration-500 rounded-2xl"></div>
                    <div className="p-6 relative">
                      <div className="flex items-center gap-4">
                        <div className="relative">
                          <div className="w-16 h-16 bg-gradient-to-br from-orange-500 to-red-500 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg">
                            <span className="text-white text-2xl">⏰</span>
                                                 ...
                                                 <div>
                           <p className="text-sm text-gray-600 dark:text-gray-400 font-medium">Průměrný skluz</p>
                           <div className="text-2xl font-bold text-gray-900 dark:text-white">
                             {loadingStats ? (
                               ...
                               averageSlip ? (
                                 <span className={
                                   averageSlip.averageSlip > 0 ? 'text-red-600 dark:text-red-400' :
                                   averageSlip.averageSlip < 0 ? 'text-green-600 dark:text-green-400' :
              ...
              <div className="relative z-10">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                  ...
                  >
                    ...
                    <span className="relative z-10 text-sm font-semibold">Přidat člena</span>
                  </button>
                  ...
                  >
                    ...
                    <span className="relative z-10 text-2xl">🚀</span>
                    <span className="relative z-10 text-sm font-semibold">Nový projekt</span>
                  </button>
                  ...
                  >
                    ...
                    <span className="relative z-10 text-2xl">📊</span>
                    <span className="relative z-10 text-sm font-semibold">Export týmu</span>
                  </button>
                  ...
                  >
                    ...
                    <span className="relative z-10 text-2xl">📈</span>
                    <span className="relative z-10 text-sm font-semibold">Export projektů</span>
                  </button>
                  ...
                  >
                    ...
                    <span className="text-2xl">📥</span>
                    <span className="text-sm font-semibold">Import projektů</span>
                  </button>
                </div>
              </div>
            </div>
