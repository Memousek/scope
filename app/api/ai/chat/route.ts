...
function todayIsoInTz(tz = 'Europe/Prague'): string {
  ...
  return fmt.format(now);
    ...
    const parts: string[] = [];
    parts.push(`Jsi profesionální expert v projektovém managementu. Odpovídej v jazyce, kterým se uživatel baví, strukturovaně a přátelsky s emoji pro lepší čitelnost. Nepozdravuj pokud k tomu nejsi vyzván.`);
